...
def home(request):
    return render(request,'heart.html',{"predicted":""})
...
def predict(request):
    ...
    return render(request,'heart.html',{"predicted":y_pred[0],"exp1":exp1,"exp2":exp2,"exp3":exp3,"exp4":exp4,"exp5":exp5,"exp6":exp6,"exp7":exp7,"exp8":exp8,"exp9":exp9,"exp10":exp10,"exp11":exp11,"exp12":exp12,"exp13":exp13,})
